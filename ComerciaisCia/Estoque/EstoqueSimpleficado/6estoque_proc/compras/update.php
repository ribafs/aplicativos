...
$sth = $pdo->prepare("SELECT id, produto_id, quantidade, preco, data from compras WHERE id = :id");
...
<select name="produto_id" id="produto_id">
   ...
   <tr><td>Preço</td><td><input name="preco" type="text" value="<?=$preco?>"></td></tr>
...
if(isset($_POST['enviar'])){
    ...
    $sql = "UPDATE compras SET produto_id=:produto_id, quantidade=:quantidade, preco=:preco, data=:data WHERE id=:id";
    $stmt= $pdo->prepare($sql);
